...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    ...
    <a href="{{route('dashboard')}}">
        ...
        <span class="mt-5 font-weight-bold font-size-h6">@lang('SMS LOTTO')</span>
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="brand flex-column-auto" id="kt_brand">
                ...
                <a href="{{route('dashboard')}}" class="brand-logo">
                    ...
                    <p class="mt-4 font-weight-bold font-size-h6">@lang('SMS LOTTO')</p>
                </a>
                <!--end::Logo-->
                <!--begin::Toggle-->
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-section">
                            <h4 class="menu-text">@lang('FUNCTION')</h4>
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item @isset($customer_register) menu-item-active @endisset" aria-haspopup="true">
                                        <a href="{{route('customer.register')}}" class="menu-link">
                                            ...
                                            <span class="menu-text">@lang('Register')</span>
                                        </a>
                                    </li>
                        ...
                        <li class="menu-item menu-item-submenu @if(isset($bill_2d3d4d5d6d)|| isset($bill_340))menu-item-open menu-item-here @endif " aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">@lang('Bills')</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item @isset($bill_2d3d4d5d6d) menu-item-active @endisset" aria-haspopup="true">
                                        <a href="{{route('bill.2d3d4d5d6d')}}" class="menu-link">
                                            ...
                                            <span class="menu-text">@lang('Bill 2d3d4d5d6d')</span>
                                        </a>
                                    </li>
                                    <li class="menu-item @isset($bill_340) menu-item-active @endisset" aria-haspopup="true">
                                        <a href="{{route('bill.340')}}" class="menu-link">
                                            ...
                                            <span class="menu-text">@lang('Bill 3/40')</span>
                                        </a>
                                    </li>
                        ...
                        <li class="menu-item menu-item-submenu @if(isset($win_2d3d4d5d6d)|| isset($win_340))menu-item-open menu-item-here @endif " aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">@lang('Winner')</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item @isset($win_2d3d4d5d6d) menu-item-active @endisset" aria-haspopup="true">
                                        <a href="{{route('win.2d3d4d5d6d')}}" class="menu-link">
                                            ...
                                            <span class="menu-text">@lang('Win 2d3d4d5d6d')</span>
                                        </a>
                                    </li>
                                    <li class="menu-item @isset($win_340) menu-item-active @endisset" aria-haspopup="true">
                                        <a href="{{route('win.340')}}" class="menu-link">
                                            ...
                                            <span class="menu-text">@lang('Win 3/40')</span>
                                        </a>
                                    </li>
                        ...
                        <li class="menu-item menu-item-submenu @if(isset($promotion_list)|| isset($promotion_create))menu-item-open menu-item-here @endif " aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <i class="menu-icon fa fa-bullhorn"></i>
                                <span class="menu-text">@lang('Promotion')</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item @isset($promotion_create) menu-item-active @endisset" aria-haspopup="true">
                                    ...
                                    <li class="menu-item @isset($promotion_list) menu-item-active @endisset" aria-haspopup="true">
                                        <a href="{{route('promotion.list')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">@lang('List')</span>
                        ...
                        <li class="menu-item  @isset($result_list) menu-item-here @endisset" aria-haspopup="true">
                            <a href="{{route('result.list')}}" class="menu-link">
                                <i class="menu-icon fas fa-registered"></i>
                        ...
                        <li class="menu-item menu-item-submenu @if(isset($recommend_list)|| isset($recommend_create))menu-item-open menu-item-here @endif " aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">@lang('Recommend lotto')</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                        ...
                        <li class="menu-item menu-item-submenu @if(isset($dream_teller_list)|| isset($dream_teller_create))menu-item-open menu-item-here @endif " aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">@lang('Dream teller')</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                        ...
                        <li class="menu-item menu-item-submenu @if(isset($notification_list)|| isset($notification_icon))menu-item-open menu-item-here @endif " aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">@lang('Notifications')</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
														<span class="navi-text">
															<span class="label label-xl label-inline label-light-success">@lang('Customers')</span>
														</span>
                                            </a>
                                        </li>
                                        <li class="navi-item">
